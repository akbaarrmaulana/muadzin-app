    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full glass-panel rounded-3xl p-8 border border-white/50">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-gray-800 tracking-tight">Login Muadzin</h2>
          <p className="text-xs text-gray-500 font-semibold uppercase tracking-widest mt-1">Masuk ke Akun Anda</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          Belum punya akun? <Link to="/register" className="text-mosque-600 font-bold hover:underline">Daftar di sini</Link>
        </p>
      </div>
    </div>
  );
